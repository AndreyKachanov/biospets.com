...
@section('page_heading', 'Категории анализов')
@section('button')
    <a style="margin-top: 50px; margin-left: 50px" href="{{ route('admin.analysescategory.create') }}" class="btn btn-primary" id="createPromotion" > Добавить категорию</a>
@endsection
...
@section('section')
    ...
    <div class="row" style="margin-top: 10px">
        <div class="col-sm-12" id="page-bottom">
            <table class="table table-category table-striped table-bordered table-hover main-table table-without-icons" id="users-table" style="width: 100%; min-width: 1024px;">
                <thead>
                <tr>
                    <th>№</th>
                    <th>Статус</th>
    ...
    <script>
        $(function() {
            ...
            var t = $('#users-table').DataTable({
                ...
                pagingType: 'numbers',
                pageLength: 25,
                ajax: '{!!route('analysesCategoryGetData') !!}',
                columns: [
