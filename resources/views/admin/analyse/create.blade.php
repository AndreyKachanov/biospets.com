...
@section('page_heading','Добавление анализа')
            ...
            <div class="col-sm-6" id="form-formatting">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="status" name="is_active">
                        <option value="{{ \App\Models\Analyse::STATUS_NOT_ACTIVE }}">@lang('statuses.analise.not_active')</option>
                        <option value="{{ \App\Models\Analyse::STATUS_ACTIVE }}">@lang('statuses.analise.active')</option>
                    </select>
                </div>
                ...
                <div class="form-group @if($errors->has('title')) has-error @endif" id="title_name_error">
                    ...
                    {{ Form::text('title','', ['class' => 'form-control', 'placeholder' => 'Введите название анализа', 'maxlength' => '1000' ]) }}
                ...
                <div class="form-group @if($errors->has('discount')) has-error @endif" id="discount_name_error">
                    ...
                    {{ Form::text('discount','', ['class' => 'form-control', 'placeholder' => 'Введите цену со скидкой' ]) }}
                </div>
                ...
                <div class="form-group @if($errors->has('price')) has-error @endif" id="price_name_error">
                    ...
                    {{ Form::text('price','', ['class' => 'form-control', 'placeholder' => 'Введите цену' ]) }}
                </div>
                ...
                <div class="form-group @if($errors->has('title_lat')) has-error @endif" id="title_lat_name_error">
                    ...
                    {{ Form::text('title_lat','', ['class' => 'form-control', 'id' => 'title_lat', 'placeholder' => 'Второе название (на латинском)', 'maxlength' => '255' ]) }}
                ...
                <div class="form-group @if($errors->has('material')) has-error @endif" id="material_name_error">
                    ...
                    {{ Form::text('material','', ['class' => 'form-control', 'placeholder' => 'Введите название биоматериала', 'maxlength' => '255']) }}
                    <div style="color: #a4aaae; margin-top: 5px;">Максимальное количество символов 255</div>
                </div>
                 ...
                 <div class="form-group @if($errors->has('preparation')) has-error @endif" id="preparation_name_error">
                    ...
                    {{ Form::text('preparation','', ['class' => 'form-control', 'placeholder' => 'Введите подготовку', 'maxlength' => '255']) }}
                    <div style="color: #a4aaae; margin-top: 5px;">Максимальное количество символов 255</div>
                </div>
                ...
                <div class="form-group @if($errors->has('result')) has-error @endif" id="result_name_error">
                    ...
                    {{ Form::text('result','', ['class' => 'form-control', 'placeholder' => 'Введите результат', 'maxlength' => '255' ]) }}
                    <div style="color: #a4aaae; margin-top: 5px;">Максимальное количество символов 255</div>
                </div>
                ...
                <div class="form-group @if($errors->has('method')) has-error @endif" id="method_name_error">
                 ...
                 <div class="form-group @if($errors->has('description')) has-error has-error-editor @endif" id="description_name_error">
                    ...
                    {{ Form::textarea('description','', ['id' => 'analyse_description', 'class' => 'form-control', 'placeholder' => 'Введите описание анализа', 'maxlength' => '5000' ]) }}
                ...
                <div class="form-group @if($errors->has('meta_title')) has-error @endif">
                    ...
                    {{ Form::text('meta_title','', ['class' => 'form-control', 'placeholder' => 'Введите meta-title', 'maxlength' => '80' ]) }}
                ...
                <div class="form-group @if($errors->has('meta_description')) has-error @endif">
                    ...
                    {{ Form::text('meta_description','', ['class' => 'form-control', 'placeholder' => 'Введите meta-description', 'maxlength' => '180' ]) }}
                ...
                <div class="form-group @if($errors->has('meta_keywords')) has-error @endif">
                    ...
                    {{ Form::text('meta_keywords','', ['class' => 'form-control', 'placeholder' => 'Введите meta-keywords', 'maxlength' => '255' ]) }}
                    <div style="color: #a4aaae; margin-top: 5px;">Максимальное количество символов 255</div>
                </div>
...
@push('scripts')
    <script>
        ...
        $('#formCreatePromotion').on('submit', function (e) {
            ...
            var ajaxUrl = '{{ route('admin.analyses.store') }}';
