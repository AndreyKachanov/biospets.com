...
@section('page_heading', 'Загруженные анализы')
...
@section('section')
    ...
    <div class="row" style="margin-top: 10px">
        <div class="col-sm-12" id="page-bottom">
            <table class="analyses-table-upload table-striped table-bordered table-hover table-without-icons"
    ...
    <script>
        ...
        $(function () {
            ...
            var t = $('#users-table').DataTable({
                ...
                pagingType: 'numbers',
                pageLength: 25,
                ajax: '{!!route('analysesGetDownloadingData') !!}',
                columns: [
                    { data: 'id', name: 'id', orderable: false, searchable: false },
                    { data: 'new', name: 'new', orderable: true, searchable: false },
