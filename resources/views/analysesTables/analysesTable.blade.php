...
<div class="table-w-alphabet">
    <div class="d-none" id="pginatorNav" data-pgination-curent="{{ $analyses->currentPage() }}" data-pagination-pages="{{ $analyses->lastPage() }}"></div>
            ...
            <table class="project-table" cellpadding="0" cellspacing="0">
                ...
                @foreach($analyses as $analysesIndex => $analyse)
                    <tr class="project-table-body-tr" data-explain-id="{{ $analyse->id }}">
                       ...
                       @if($analyse->rAnalysesCategories)
...
<section class="content-section" id="category_description">
        <div class="block-background block-background--1  block-background-img--{{$imgArray[4]}} d-none d-md-block"></div>
